    ...
    <div className={classes.container}>
      <article className={classes.article}>
        <div className={classes['sub-article_content']}>
            <p>
                Mazury, a dla nas ściślej Kraina Wielkich Jezior Mazurskich to kompleks kilkunastu jezior połączonych systemem kanałów, położony na unikalnym obszarze pod względem walorów przyrodniczych, który stanowi wyjątkowy, śródlądowy szlak żeglugowy w Europie. To piękne miejsce do odpoczynku i świetne do uprawiania żeglarstwa.<br />Organizujemy tam rejsy:<br /> szkoleniowe i turystyczne.<br /> Weekendowe i kilkunastodniowe. <br />Intensywne i na zupełnym luzie.<br /> Jeśli chcesz pożeglować po Wielkich Jeziorach Mazurskich to z nami na pewno nie będziesz tego żałować. Znamy tam każdy zakątek i wszystkie miejsca do których warto popłynąć, a wieczorem gwarantujemy wspaniałą zabawę przy ognisku ze śpiewem, z gitarą lub w tawernach portowych, kameralnie lub w towarzystwie wielu żeglarzy.
            </p>
        </div>
